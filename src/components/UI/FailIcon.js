import './FailIcon.css'
export const FailIcon = (<div id="overallStatus red">
<svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="45px" height="45px" viewBox="0 0 45 45" version="1.1">
...
<g id="Rectangle-134">
  ...
  <use fill="#F1342F" fill-rule="evenodd" xlinkHref="#path-1" />
  <use fill="black" fill-opacity="1" filter="url(#filter-3)" xlinkHref="#path-1" />
